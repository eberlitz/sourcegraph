...
# Table "public.campaign_user_tokens"
```
       Column        |           Type           |       Modifiers        
---------------------+--------------------------+------------------------
 ...
 updated_at          | timestamp with time zone | not null default now()
Indexes:
    "campaign_user_tokens_pkey" PRIMARY KEY, btree (user_id, external_service_id)
Foreign-key constraints:
    "campaign_user_tokens_external_service_id_fkey" FOREIGN KEY (external_service_id) REFERENCES external_services(id) ON DELETE CASCADE DEFERRABLE
    "campaign_user_tokens_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE DEFERRABLE
...
Referenced by:
    TABLE "campaign_user_tokens" CONSTRAINT "campaign_user_tokens_external_service_id_fkey" FOREIGN KEY (external_service_id) REFERENCES external_services(id) ON DELETE CASCADE DEFERRABLE
...
Referenced by:
    ...
    TABLE "campaign_user_tokens" CONSTRAINT "campaign_user_tokens_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE DEFERRABLE
